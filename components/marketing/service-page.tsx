...
import type { ServiceDefinition } from "@/lib/marketing-content";
    ...
    <MarketingShell structuredData={structuredData}>
        ...
        <div className="container marketing-hero__inner">
          <div className="marketing-hero__copy" data-reveal>
            ...
            <div className="v3-actions">
              <Link className="v3-action v3-action--solid" data-event="primary_cta_clicked" data-event-label={`${service.slug}: diagnostic`} data-event-source="service-hero" href="/#audit">Check my clinic <span aria-hidden="true">↘</span></Link>
      ...
      <section className="marketing-conversion" aria-labelledby="service-conversion-title" data-kai-avoid>
        <div className="container marketing-conversion__inner">
          ...
          <div className="v3-actions">
            <Link className="v3-action v3-action--solid" data-event="primary_cta_clicked" data-event-label={`${service.slug}: final diagnostic`} data-event-source="service-final" href="/#audit">Check my clinic <span aria-hidden="true">↗</span></Link>
