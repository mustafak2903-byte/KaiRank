...
const sections = [
  { title: "Information you choose to provide", body: "When you request a deeper review, KaiRank may receive your email address, clinic name, number of locations, website, location, priority treatment or service and limited campaign-attribution information attached to that request. When you book a conversation, Cal.com receives the details you enter into its booking interface." },
